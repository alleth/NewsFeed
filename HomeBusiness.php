...
<div id = "titleId">
	<fieldset id = "fieldhome">
        ...
        <fieldset id = "srchResult"></fieldset>
	</fieldset>
</div>
<br></br>
<br>
...
<div>
		<a class = "featStyle" href = "HomeBusiness.php"><strong 
...
<body>
			...
			<div class = "back_post2" id = "back">
				...
				<br>
				<input type = "submit" value = "POST" class = "btn btn-primary" id = "btn_business">
				</br>
			</div>
