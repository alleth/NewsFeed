...
<div>
	...
	<strong class = "divMenu" id = "homeId">Home</strong></a>
</div>
...
<div>
		<a class = "featStyle" href = "HomeEntertainment.php"><strong style = "cursor:pointer;
		...
		id = "homeId"
		id = "EntertainmentId">Entertainment</strong></a>
</div>
...
<body>
			...
			<div  class = "back_post2" id = "back">
				...
				<br>
				<input type = "submit" value = "POST" class = "btn btn-primary" id = "btn_entertainment">
				</br>
			</div>
