...
<div>
		<a class = "featStyle" href = "HomeHealth.php"><strong 
...
<body>
			...
			<div class = "back_post2" id = "back">
				...
				<br>
				<input type = "submit" value = "POST" class = "btn btn-primary" id = "btn_health">
				</br>
			</div>
